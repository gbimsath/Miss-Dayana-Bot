...
◉──────────────────────────────────◉
 **Sinhala MemeHub Users** : `{count}`
 **⚜️Sinhala MemeHub Family⚜️ (Admins)**   : `{counta}`
 **Miss Dayana Users** : `{countb}`
◉──────────────────────────────────◉
🖥 **System Information**
...
""",
                 ...
                 [
                 InlineKeyboardButton('🐞 Report Bugs 🐞', user_id="1263393688")
                 ],
                 [
                 InlineKeyboardButton('Miss Dayana', user_id="@Miss_Dayana_Bot")
                 ],
                 [
...
""",
                    reply_markup=InlineKeyboardMarkup([[              
                 InlineKeyboardButton('Sinhala MemeHub', url="https://t.me/meme_hub_lk")
                 ],
                 [
                 InlineKeyboardButton('Owner 👑', user_id="@SAVINDU_DESHAN")
                 ],
                 [
                 InlineKeyboardButton('Official Bot🤖', user_id="@Miss_Dayana_Bot")
                 ],
                 [
                 InlineKeyboardButton("⚜️Special Entrance⚜️", url="https://t.me/Pappa_Gama")
                 ]])
